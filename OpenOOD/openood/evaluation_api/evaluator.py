    ...
    def eval_ood(self, fsood: bool = False, progress: bool = True):
        ...
        if self.metrics[task] is None:
            ...
            if self.scores['id']['test'] is None:
                ...
                # In contrast to official OpenOOD, we also save the paths to evaluated data. This allows us to differentiate the samples that were used for training of the likelihood ratio
